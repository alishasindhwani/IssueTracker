...
<%
   ...
   Connection conn = null;
	...
	try {
		...
		rset = stmt.executeQuery("select F.iid, F.fid, F.description from Fix F Where F.fid NOT IN (Select fid from Verifies)");
		...
		if(fid !=null)
		{
			String t = "insert into verifies (tid, fid, verifydate) values (" + sid + "," +  fid + "," + "'" + date + "')";
...
<body>
	...
	<h3>Verify a fix:</h3>
	<form name="verifyfix" action="verifyfix.jsp" method="post">
	<%
			if (rset != null) {
		...
		%>
		<input type="submit" value="Verify Fix">
	</form>
</body>
</html>